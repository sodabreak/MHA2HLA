...
class LlamaBenchmark:
    ...
    def benchmark_inference(self, input_texts, seq_lengths=[128, 256, 512, 1024, 2048], gen_lengths=[20, 50, 100], trials=10):
            ...
            for seq_length in seq_lengths:
                for gen_length in gen_lengths:
                    ...
                    if self.enable_profiling:
                        ...
                        orig_prof.export_chrome_trace(f"{self.output_dir}/original_profile_seq{seq_length}_gen{gen_length}.json")
                    ...
                    if self.enable_profiling:
                        ...
                        hla_prof.export_chrome_trace(f"{self.output_dir}/hla_profile_seq{seq_length}_gen{gen_length}.json")
        ...
        df.to_csv(f"{self.output_dir}/inference_benchmark_results.csv", index=False)
        return df
...
if __name__ == "__main__":
    benchmark = LlamaBenchmark(model_name="AICrossSim/clm-60m", tokenizer_name="HuggingFaceTB/cosmo2-tokenizer", enable_profiling=False)
